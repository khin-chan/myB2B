...
/**
 * Generated class for the NotipostPage page.
 *
...
@Component({
  selector: 'page-notipost',
  templateUrl: 'notipost.html',
  providers: [FunctProvider, ChangelanguageProvider, ChangefontProvider]
})
export class NotipostPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public storage: Storage,
    ...
    public changeLanguage: ChangelanguageProvider, public datepipe: DatePipe,
    ...
    this.storage.get('billStatus').then((data) => {
      ...
      console.log("notipost billstatus == " + this.billStatus);
    });
  ...
  getLike(data) {
    ...
    console.log("data in getLike notipost page >> ", JSON.stringify(data));
    let parameter = {
      key: data.syskey,
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad NotipostPage');
  }
