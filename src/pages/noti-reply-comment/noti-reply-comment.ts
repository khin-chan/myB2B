...
/**
 * Generated class for the NotiReplyCommentPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
@Component({
  selector: 'page-noti-reply-comment',
  templateUrl: 'noti-reply-comment.html',
  providers: [ChangelanguageProvider]
})
export class NotiReplyCommentPage {
  ...
  constructor(public loadingCtrl: LoadingController, public navCtrl: NavController, public navParams: NavParams,
    public viewCtrl: ViewController, public storage: Storage, public alert: AlertController, private _zone: NgZone,
    ...
    public clipboard: Clipboard, public changefont: ChangefontProvider, public events: Events, private sqlite: SQLite) {
    ...
    // if(this.passData.iconStatus =="reply"){
    //   this.passData.syskey = this.passData.postSyskey;
    //   console.log("this.passData.syskey == "+JSON.stringify(this.passData.syskey));
    // }
  ...
  getCommentData() {
    ...
    this.http.get(this.funct.ipaddress2 + 'serviceQuestion/getCommentReplymobile?id=' + this.passData.postSyskey + '&userSK=' + this.registerData.syskey + '&sessionKey=' + this.registerData.sessionKey).map(res => res.json()).subscribe(result => {
