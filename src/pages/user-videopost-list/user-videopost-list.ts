...
/**
 * Generated class for the UserVideopostListPage page.
 *
...
@Component({
  selector: 'page-user-videopost-list',
  templateUrl: 'user-videopost-list.html',
  providers: [ChangelanguageProvider]
})
export class UserVideopostListPage {
  popover: any;
  items: any[];
  data: any = [];
  url: string = '';
  ...
  b2bdata: any = [];
  db: any;
  textMyan: any = ["Video", "ဒေတာ မရှိပါ။"];
  textEng: any = ["Video", "No result found"];
  textData: any = [];
  passData: any = "tmn";
  billStatus: any;
  mptPopup: any;
  ...
  getList(start, infiniteScroll) {
    ...
    this.http.post(this.funct.ipaddress2 + "serviceArticle/getPostListByContentWriter?usersk=" + this.registerData.syskey + "&userid=" + this.registerData.t1 + '&sessionKey=' + this.registerData.sessionKey + '&type=video', parm).map(res => res.json()).subscribe(data => {
                  ...
                  for (let j = 0; j < this.pinmenuList[i].menu_arr.length; j++) {
                    ...
                    if (this.pinmenuList[i].menu_arr[j].n10 == 1) {
                      if (this.pinmenuList[i].menu_arr[j].t8 != '') {
                        ...
                        this.pinmenuList[i].menu_arr[j].videoUploadLink = this.pinmenuList[i].menu_arr[j].t8;
                        console.log("data.data[i].t8 for vimeo == " + this.pinmenuList[i].menu_arr[j].videoUploadLink);
                      ...
                      this.pinmenuList[i].menu_arr[j].videoUploadLink = this.pinmenuList[i].menu_arr[j].t8;
                      console.log("data.data[i].t8 for youtube == " + this.pinmenuList[i].menu_arr[j].videoUploadLink);
                      ...
                      if (this.pinmenuList[i].menu_arr[j].uploadedPhoto.length > 0) {
                        if (this.pinmenuList[i].menu_arr[j].uploadedPhoto[0].t2 != '') {
                          ...
                          this.pinmenuList[i].menu_arr[j].videoUploadLink =this.pinmenuList[i].menu_arr[j].uploadedPhoto[0].t2;
                          console.log("data.data[i].t8 for mp4 == " + this.pinmenuList[i].menu_arr[j].videoUploadLink);
                        }
                        else {
                    ...
                    this.changeLanguage.changelanguageText(this.font, this.pinmenuList[i].menu_arr[j].t1).then((data) => {
                      console.log("Title Font " + JSON.stringify(data));
                  ...
                  for (let j = 0; j < this.menuList[i].menu_arr.length; j++) {
                    ...
                    if (this.menuList[i].menu_arr[j].n10 == 1) {
                      if (this.menuList[i].menu_arr[j].t8 != '') {
                        ...
                        this.menuList[i].menu_arr[j].videoUploadLink = this.menuList[i].menu_arr[j].t8 ;
                        console.log("data.data[i].t8 for vimeo == " + this.menuList[i].menu_arr[j].videoUploadLink);
                      ...
                      this.menuList[i].menu_arr[j].videoUploadLink = this.menuList[i].menu_arr[j].t8 ;
                      console.log("data.data[i].t8 for youtube == " + this.menuList[i].menu_arr[j].videoUploadLink);
                      ...
                      if (this.menuList[i].menu_arr[j].uploadedPhoto.length > 0) {
                        if (this.menuList[i].menu_arr[j].uploadedPhoto[0].t2 != '') {
                          ...
                          this.menuList[i].menu_arr[j].videoUploadLink =this.menuList[i].menu_arr[j].uploadedPhoto[0].t2;
                          console.log("data.data[i].t8 for mp4 == " + this.menuList[i].menu_arr[j].videoUploadLink);
                        }
                        else {
                    ...
                    this.changeLanguage.changelanguageText(this.font, this.menuList[i].menu_arr[j].t2).then((data) => {
                      ...
                      if (temp.indexOf("[#img]") > -1) {
                        ...
                        console.log("Edit MenuList == " + JSON.stringify(temp1));
                      }
                      else {
                        let tempArr = temp.split("</p>");
                        console.log("Array Data>>>>" + JSON.stringify(tempArr));
                  ...
                  for (let j = 0; j < tempData[i].menu_arr.length; j++) {
                    ...
                    if (tempData[i].menu_arr[j].n10 == 1) {
                      if (tempData[i].menu_arr[j].t8 != '') {
                        ...
                        tempData[i].menu_arr[j].videoUploadLink = tempData[i].menu_arr[j].t8;
                        console.log("data.data[i].t8 for vimeo == " + tempData[i].menu_arr[j].videoUploadLink);
                      ...
                      tempData[i].menu_arr[j].videoUploadLink = tempData[i].menu_arr[j].t8;
                      console.log("data.data[i].t8 for youtube == " + tempData[i].menu_arr[j].videoUploadLink);
                      ...
                      if (tempData[i].menu_arr[j].uploadedPhoto.length > 0) {
                        if (tempData[i].menu_arr[j].uploadedPhoto[0].t2 != '') {
                          ...
                          tempData[i].menu_arr[j].videoUploadLink = tempData[i].menu_arr[j].uploadedPhoto[0].t2;
                          console.log("data.data[i].t8 for mp4 == " +  tempData[i].menu_arr[j].videoUploadLink);
                        }
                        else {
  ...
  ionViewDidLoad() {
    console.log('UserVideoPostListPage');
  }
